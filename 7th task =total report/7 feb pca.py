# -*- coding: utf-8 -*-
"""
Created on Mon Feb  7 09:12:08 2022
...
# plt.show()
score =silhouette_score(pcatest[:,1:], yhat10)
...
axs6[0].scatter(pcatest[:, 0]*50 ,xs,c=yhat10[:,1])
...
for i in range(0,629):
    ...
    axs6[1].plot(range((int(matrix[i,0]))*50,int(matrix[i,0]+1)*50),matrix[i,52:],color(yhat10[i,1]))
